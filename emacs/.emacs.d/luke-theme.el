...
(custom-theme-set-faces
 'luke
 '(default ((t (:family "DejaVu Sans Mono" :foundry "PfEd" :width normal :height 102 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "white" :background "#222226" :stipple nil :inherit nil))))
